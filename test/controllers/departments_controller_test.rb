...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post departments_url, params: { department: { Dep_location: @department.Dep_location, Dep_name: @department.Dep_name } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { Dep_location: @department.Dep_location, Dep_name: @department.Dep_name } }
