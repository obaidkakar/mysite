...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { Cell: @instructor.Cell, Email: @instructor.Email, F_name: @instructor.F_name, Ins_name: @instructor.Ins_name, department_id: @instructor.department_id } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { Cell: @instructor.Cell, Email: @instructor.Email, F_name: @instructor.F_name, Ins_name: @instructor.Ins_name, department_id: @instructor.department_id } }
